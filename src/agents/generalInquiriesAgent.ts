...
export const consultasGeneralesValidatorAgent = async (userInput: string, perfilActual: any) => {
    return await ai.generate({
        system: `Eres el validador de información general del cliente, asegurate que la información sea correcta y completa. 
                 ...
                 2. Si el usuario dio su edad, ocupación o tipo de cliente, actualiza la ficha.
                 3. Si faltan datos, pon "datosCompletos": false.
                 4. Solo si ya tienes (Tipo de Cliente, Ocupación y Edad), pon "datosCompletos": true.`,
        prompt: userInput,
